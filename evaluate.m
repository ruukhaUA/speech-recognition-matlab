...
%
%   Al finalizar, informa del WER medio (caracter y palabra) considerando solo los
%   ficheros con transcripción válida.
%
%   DEVUELVE dos vectores con los WER para ambas granularidades (caracter y
%   palabra).
%
...
%
%   Ejemplo:
%       [werValuesChar, werValuesWord] = evaluate(100)
%
    ...
    audioFiles = findAudioFiles(audioDir);
